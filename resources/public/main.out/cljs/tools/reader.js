...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__23449 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23449,ch);
...
if(("\\" === ch__$1)){
var ch_23450__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_23450__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_23450__$2);
} else {
}

var G__23451 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__23451;
continue;
}
}
...
var vec__23459 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23459,(0),null);
var start_column = cljs.core.nth.call(null,vec__23459,(1),null);
...
var G__23462 = cljs.core.conj_BANG_.call(null,a,form);
a = G__23462;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__23463 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__23464 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__23464);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__23463);
}});
/**
...
var vec__23468 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23468,(0),null);
var end_column = cljs.core.nth.call(null,vec__23468,(1),null);
...
var sb = (function (){var G__23483 = (new goog.string.StringBuffer());
G__23483.append(initch);
...
var G__23485 = (function (){var G__23484 = sb;
G__23484.append(ch);

return G__23484;
})();
var G__23486 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__23485;
ch = G__23486;
continue;
}
...
switch (G__23489) {
case "\\":
var G__23493 = (function (){var G__23490 = sb;
G__23490.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__23490;
})();
var G__23494 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23493;
ch = G__23494;
continue;
...
break;
default:
var G__23495 = (function (){var G__23491 = sb;
G__23491.append(ch);

return G__23491;
})();
var G__23496 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__23495;
ch = G__23496;
continue;
...
var vec__23500 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23500,(0),null);
var column = cljs.core.nth.call(null,vec__23500,(1),null);
...
var vec__23505 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23505,(0),null);
var column = cljs.core.nth.call(null,vec__23505,(1),null);
...
var vec__23510 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__23510,(0),null);
var column = cljs.core.nth.call(null,vec__23510,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__23515 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__23515,(0),null);
var start_column = cljs.core.nth.call(null,vec__23515,(1),null);
...
var vec__23518 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__23518,(0),null);
var end_column = cljs.core.nth.call(null,vec__23518,(1),null);
...
var G__23521 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__23521,true,null,opts,pending_forms);
...
var G__23522 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__23522)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__23522)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__23522)){
...
var _STAR_suppress_read_STAR__orig_val__23523 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__23524 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__23524);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__23523);
}});
...
var G__23525 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__23525,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__23525,rdr,first_line);
...
var G__23529 = matched;
var G__23530 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__23529;
finished = G__23530;
continue;
} else {
...
var _STAR_suppress_read_STAR__temp_val__23532 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var arg_env_orig_val__23533 = cljs.tools.reader.arg_env;
var arg_env_temp_val__23534 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__23534);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__23535 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__23535,"(");
...
var G__23536 = (i + (1));
var G__23537 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__23533);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__23538 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__23538);
...
var G__23539 = cljs.core.next.call(null,s__$1);
var G__23540 = ret;
s__$1 = G__23539;
r = G__23540;
continue;
...
var G__23541 = cljs.core.next.call(null,s);
var G__23542 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__23541;
key_vals = G__23542;
continue;
} else {
...
var gensym_env_orig_val__23547 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__23548 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__23548);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__23547);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__23549 = token;
var G__23549__$1 = (((G__23549 == null))?null:cljs.core.subs.call(null,G__23549,(1)));
var G__23549__$2 = (((G__23549__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23549__$1));
var G__23549__$3 = (((G__23549__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23549__$2));
var G__23549__$4 = (((G__23549__$3 == null))?null:cljs.core.symbol.call(null,G__23549__$3));
if((G__23549__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__23549__$4);
}
})():(function (){var G__23550 = token;
var G__23550__$1 = (((G__23550 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__23550));
if((G__23550__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__23550__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__23561,reader){
...
var eof = cljs.core.get.call(null,map__23562__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
