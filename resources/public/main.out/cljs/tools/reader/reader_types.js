...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_19429 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_19429(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_19430 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_19430(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19431 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_19431(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19432 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_19432(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19433 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_19433(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19434 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_19434(reader);
}
});
...
var G__19445 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__19446 = s.append(c);
c = G__19445;
s = G__19446;
continue;
}
