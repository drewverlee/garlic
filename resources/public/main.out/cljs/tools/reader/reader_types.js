...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_20202 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_20202(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_20203 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_20203(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_20204 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_20204(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_20205 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_20205(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_20206 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_20206(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_20207 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_20207(reader);
}
});
...
var G__20218 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__20219 = s.append(c);
c = G__20218;
s = G__20219;
continue;
}
