...
var temp__5735__auto___20083 = odoyle.rum._STAR_react_component_STAR_;
if(cljs.core.truth_(temp__5735__auto___20083)){
var cmp_20084 = temp__5735__auto___20083;
...
var _STAR_local_pointer_STAR__orig_val__20085 = odoyle.rum._STAR_local_pointer_STAR_;
var _STAR_react_component_STAR__orig_val__20086 = odoyle.rum._STAR_react_component_STAR_;
var _STAR_can_return_atom_QMARK__STAR__orig_val__20087 = odoyle.rum._STAR_can_return_atom_QMARK__STAR_;
var _STAR_prop_STAR__orig_val__20088 = odoyle.rum._STAR_prop_STAR_;
var _STAR_match_STAR__orig_val__20089 = odoyle.rules._STAR_match_STAR_;
var _STAR_local_pointer_STAR__temp_val__20090 = cljs.core.cst$kw$odoyle$rum_SLASH_local_DASH_pointer.cljs$core$IFn$_invoke$arity$1(state);
var _STAR_react_component_STAR__temp_val__20091 = cljs.core.cst$kw$rum_SLASH_react_DASH_component.cljs$core$IFn$_invoke$arity$1(state);
var _STAR_can_return_atom_QMARK__STAR__temp_val__20092 = cljs.core.volatile_BANG_(true);
var _STAR_prop_STAR__temp_val__20093 = cljs.core.first(cljs.core.cst$kw$rum_SLASH_args.cljs$core$IFn$_invoke$arity$1(state));
var _STAR_match_STAR__temp_val__20094 = cljs.core.deref(_STAR_match);
(odoyle.rum._STAR_local_pointer_STAR_ = _STAR_local_pointer_STAR__temp_val__20090);

(odoyle.rum._STAR_react_component_STAR_ = _STAR_react_component_STAR__temp_val__20091);

(odoyle.rum._STAR_can_return_atom_QMARK__STAR_ = _STAR_can_return_atom_QMARK__STAR__temp_val__20092);

(odoyle.rum._STAR_prop_STAR_ = _STAR_prop_STAR__temp_val__20093);

(odoyle.rules._STAR_match_STAR_ = _STAR_match_STAR__temp_val__20094);
...
}finally {(odoyle.rules._STAR_match_STAR_ = _STAR_match_STAR__orig_val__20089);

(odoyle.rum._STAR_prop_STAR_ = _STAR_prop_STAR__orig_val__20088);

(odoyle.rum._STAR_can_return_atom_QMARK__STAR_ = _STAR_can_return_atom_QMARK__STAR__orig_val__20087);

(odoyle.rum._STAR_react_component_STAR_ = _STAR_react_component_STAR__orig_val__20086);

(odoyle.rum._STAR_local_pointer_STAR_ = _STAR_local_pointer_STAR__orig_val__20085);
}});
...
var temp__5735__auto___20095 = cljs.core.deref(cljs.core.cst$kw$odoyle$rum_SLASH_local_DASH_pointer.cljs$core$IFn$_invoke$arity$1(state));
if(cljs.core.truth_(temp__5735__auto___20095)){
var _STAR_local_20096 = temp__5735__auto___20095;
cljs.core.remove_watch(_STAR_local_20096,cljs.core.cst$kw$odoyle$rum_SLASH_local);
} else {
}
...
cljs.spec.alpha.def_impl(cljs.core.cst$kw$odoyle$rum_SLASH_what_DASH_id,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_or,cljs.core.cst$kw$value,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_and,cljs.core.cst$kw$odoyle$rules_SLASH_id,cljs.core.list(cljs.core.cst$sym$fn_STAR_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$p1__20097_SHARP_], null),cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_not,cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_symbol_QMARK_,cljs.core.cst$sym$p1__20097_SHARP_))))),cljs.spec.alpha.or_spec_impl(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$value], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_and,cljs.core.cst$kw$odoyle$rules_SLASH_id,cljs.core.list(cljs.core.cst$sym$fn_STAR_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$p1__20097_SHARP_], null),cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_not,cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_symbol_QMARK_,cljs.core.cst$sym$p1__20097_SHARP_))))], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.spec.alpha.and_spec_impl(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$odoyle$rules_SLASH_id,cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_fn,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$_PERCENT_], null),cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_not,cljs.core.list(cljs.core.cst$sym$cljs$core_SLASH_symbol_QMARK_,cljs.core.cst$sym$_PERCENT_)))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$odoyle$rules_SLASH_id,(function (p1__20097_SHARP_){
return (!((p1__20097_SHARP_ instanceof cljs.core.Symbol)));
})], null),null)], null),null));
