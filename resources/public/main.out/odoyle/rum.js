...
var temp__5735__auto___23223 = odoyle.rum._STAR_react_component_STAR_;
if(cljs.core.truth_(temp__5735__auto___23223)){
var cmp_23224 = temp__5735__auto___23223;
...
var _STAR_local_pointer_STAR__orig_val__23225 = odoyle.rum._STAR_local_pointer_STAR_;
var _STAR_react_component_STAR__orig_val__23226 = odoyle.rum._STAR_react_component_STAR_;
var _STAR_can_return_atom_QMARK__STAR__orig_val__23227 = odoyle.rum._STAR_can_return_atom_QMARK__STAR_;
var _STAR_prop_STAR__orig_val__23228 = odoyle.rum._STAR_prop_STAR_;
var _STAR_match_STAR__orig_val__23229 = odoyle.rules._STAR_match_STAR_;
var _STAR_local_pointer_STAR__temp_val__23230 = new cljs.core.Keyword("odoyle.rum","local-pointer","odoyle.rum/local-pointer",-551093055).cljs$core$IFn$_invoke$arity$1(state);
var _STAR_react_component_STAR__temp_val__23231 = new cljs.core.Keyword("rum","react-component","rum/react-component",-1879897248).cljs$core$IFn$_invoke$arity$1(state);
var _STAR_can_return_atom_QMARK__STAR__temp_val__23232 = cljs.core.volatile_BANG_.call(null,true);
var _STAR_prop_STAR__temp_val__23233 = cljs.core.first.call(null,new cljs.core.Keyword("rum","args","rum/args",1315791754).cljs$core$IFn$_invoke$arity$1(state));
var _STAR_match_STAR__temp_val__23234 = cljs.core.deref.call(null,_STAR_match);
(odoyle.rum._STAR_local_pointer_STAR_ = _STAR_local_pointer_STAR__temp_val__23230);

(odoyle.rum._STAR_react_component_STAR_ = _STAR_react_component_STAR__temp_val__23231);

(odoyle.rum._STAR_can_return_atom_QMARK__STAR_ = _STAR_can_return_atom_QMARK__STAR__temp_val__23232);

(odoyle.rum._STAR_prop_STAR_ = _STAR_prop_STAR__temp_val__23233);

(odoyle.rules._STAR_match_STAR_ = _STAR_match_STAR__temp_val__23234);

try{return render_fn.call(null,state);
}finally {(odoyle.rules._STAR_match_STAR_ = _STAR_match_STAR__orig_val__23229);

(odoyle.rum._STAR_prop_STAR_ = _STAR_prop_STAR__orig_val__23228);

(odoyle.rum._STAR_can_return_atom_QMARK__STAR_ = _STAR_can_return_atom_QMARK__STAR__orig_val__23227);

(odoyle.rum._STAR_react_component_STAR_ = _STAR_react_component_STAR__orig_val__23226);

(odoyle.rum._STAR_local_pointer_STAR_ = _STAR_local_pointer_STAR__orig_val__23225);
}});
...
var temp__5735__auto___23235 = cljs.core.deref.call(null,new cljs.core.Keyword("odoyle.rum","local-pointer","odoyle.rum/local-pointer",-551093055).cljs$core$IFn$_invoke$arity$1(state));
if(cljs.core.truth_(temp__5735__auto___23235)){
var _STAR_local_23236 = temp__5735__auto___23235;
cljs.core.remove_watch.call(null,_STAR_local_23236,new cljs.core.Keyword("odoyle.rum","local","odoyle.rum/local",-2031085296));
} else {
}
...
cljs.spec.alpha.def_impl.call(null,new cljs.core.Keyword("odoyle.rum","what-id","odoyle.rum/what-id",1834191592),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","or","cljs.spec.alpha/or",-831679639,null),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","and","cljs.spec.alpha/and",-2060279705,null),new cljs.core.Keyword("odoyle.rules","id","odoyle.rules/id",874134163),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__23237#","p1__23237#",-2129230210,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","not","cljs.core/not",100665144,null),cljs.core.list(new cljs.core.Symbol("cljs.core","symbol?","cljs.core/symbol?",1422196122,null),new cljs.core.Symbol(null,"p1__23237#","p1__23237#",-2129230210,null)))))),cljs.spec.alpha.or_spec_impl.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.list(new cljs.core.Symbol("cljs.spec.alpha","and","cljs.spec.alpha/and",-2060279705,null),new cljs.core.Keyword("odoyle.rules","id","odoyle.rules/id",874134163),cljs.core.list(new cljs.core.Symbol(null,"fn*","fn*",-752876845,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"p1__23237#","p1__23237#",-2129230210,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","not","cljs.core/not",100665144,null),cljs.core.list(new cljs.core.Symbol("cljs.core","symbol?","cljs.core/symbol?",1422196122,null),new cljs.core.Symbol(null,"p1__23237#","p1__23237#",-2129230210,null)))))], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.spec.alpha.and_spec_impl.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("odoyle.rules","id","odoyle.rules/id",874134163),cljs.core.list(new cljs.core.Symbol("cljs.core","fn","cljs.core/fn",-1065745098,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"%","%",-950237169,null)], null),cljs.core.list(new cljs.core.Symbol("cljs.core","not","cljs.core/not",100665144,null),cljs.core.list(new cljs.core.Symbol("cljs.core","symbol?","cljs.core/symbol?",1422196122,null),new cljs.core.Symbol(null,"%","%",-950237169,null))))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("odoyle.rules","id","odoyle.rules/id",874134163),(function (p1__23237_SHARP_){
return (!((p1__23237_SHARP_ instanceof cljs.core.Symbol)));
})], null),null)], null),null));
