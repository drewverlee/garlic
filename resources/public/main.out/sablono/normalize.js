...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__12436){
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__12440_SHARP_){
return (((p1__12440_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__12440_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__12441,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__12441;
}
});
...
args__4742__auto__.push((arguments[i__4737__auto___12445]));
...
var G__12443 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12443,cljs.core.cst$kw$class,cljs.core.vec(classes));
} else {
return G__12443;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq12442){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq12442));
}));
...
var vec__12449 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_((function (){var G__12453 = cljs.core.ffirst(matches);
var fexpr__12452 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__12452.cljs$core$IFn$_invoke$arity$1 ? fexpr__12452.cljs$core$IFn$_invoke$arity$1(G__12453) : fexpr__12452.call(null,G__12453));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12449,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12449,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__12447_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__12447_SHARP_))){
return p1__12447_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__12448_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__12448_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__12455){
var vec__12456 = p__12455;
var seq__12457 = cljs.core.seq(vec__12456);
var first__12458 = cljs.core.first(seq__12457);
var seq__12457__$1 = cljs.core.next(seq__12457);
var tag = first__12458;
var content = seq__12457__$1;
...
var vec__12459 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12459,(2),null);
