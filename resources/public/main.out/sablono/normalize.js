...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__17072){
var vec__17073 = p__17072;
var _ = cljs.core.nth.call(null,vec__17073,(0),null);
var v = cljs.core.nth.call(null,vec__17073,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__17076_SHARP_){
return (((p1__17076_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__17076_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__17077,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__17077;
}
});
...
var G__17079 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__17079,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__17079;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq17078){
...
var vec__17085 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__17085,(0),null);
var names = cljs.core.nth.call(null,vec__17085,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,(function (p1__17083_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__17083_SHARP_))){
return p1__17083_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__17084_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__17084_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__17088){
...
var tag = first__17091;
var content = seq__17090__$1;
...
var vec__17092 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__17092,(0),null);
var id = cljs.core.nth.call(null,vec__17092,(1),null);
var class$ = cljs.core.nth.call(null,vec__17092,(2),null);
