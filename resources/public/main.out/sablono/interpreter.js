...
var sablono$interpreter$IInterpreter$interpret$dyn_13240 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_13240(this$);
}
});
...
goog.object.extend(state,props,({"onChange": (function (){var G__13241 = goog.object.get(this$,"onChange");
var G__13242 = this$;
return goog.bind(G__13241,G__13242);
})()}));
...
var x13243_13244 = ctor.prototype;
(x13243_13244.onChange = (function (event){
var this$ = this;
...
(x13243_13244.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__13248) {
case "input":
var G__13249 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__13249) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq13252){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13253,G__13254,seq13252__$2);
}));
...
var vec__13259 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13259,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13259,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13259,(2),null);
