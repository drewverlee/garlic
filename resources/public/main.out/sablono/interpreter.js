...
var sablono$interpreter$IInterpreter$interpret$dyn_12464 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_12464(this$);
}
});
...
goog.object.extend(state,props,({"onChange": (function (){var G__12465 = goog.object.get(this$,"onChange");
var G__12466 = this$;
return goog.bind(G__12465,G__12466);
})()}));
...
var x12467_12468 = ctor.prototype;
(x12467_12468.onChange = (function (event){
var this$ = this;
...
(x12467_12468.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__12472) {
case "input":
var G__12473 = ((cljs.core.object_QMARK_(props))?props.type:false);
switch (G__12473) {
case "radio":
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq12476){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12477,G__12478,seq12476__$2);
}));
...
var vec__12483 = sablono.normalize.element(element);
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(0),null);
var attrs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(1),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12483,(2),null);
