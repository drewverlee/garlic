...
var sablono$interpreter$IInterpreter$interpret$dyn_17097 = (function (this$){
...
return sablono$interpreter$IInterpreter$interpret$dyn_17097.call(null,this$);
}
});
...
var x17098_17099 = ctor.prototype;
(x17098_17099.onChange = (function (event){
var this$ = this;
...
(x17098_17099.componentWillReceiveProps = (function (new_props){
var this$ = this;
...
switch (G__17103) {
case "input":
var G__17104 = ((cljs.core.object_QMARK_.call(null,props))?props.type:false);
switch (G__17104) {
case "radio":
...
var len__4736__auto___17110 = arguments.length;
var i__4737__auto___17111 = (0);
while(true){
if((i__4737__auto___17111 < len__4736__auto___17110)){
args__4742__auto__.push((arguments[i__4737__auto___17111]));

var G__17112 = (i__4737__auto___17111 + (1));
i__4737__auto___17111 = G__17112;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.interpreter.create_element.cljs$lang$applyTo = (function (seq17107){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17108,G__17109,seq17107__$2);
}));
...
var vec__17114 = sablono.normalize.element.call(null,element);
var type = cljs.core.nth.call(null,vec__17114,(0),null);
var attrs = cljs.core.nth.call(null,vec__17114,(1),null);
var content = cljs.core.nth.call(null,vec__17114,(2),null);
